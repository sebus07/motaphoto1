...
<body>
    ...
    <script>
        // Récupérer les paramètres du thème et les stocker dans une variable JavaScript
        let themeSettings = {
            titre: '<?php echo esc_js(motaphoto1_get_theme_settings()['titre']); ?>',
            reference: '<?php echo esc_js(motaphoto1_get_theme_settings()['reference']); ?>',
            categorie: '<?php echo esc_js(motaphoto1_get_theme_settings()['categorie']); ?>',
            // et ainsi de suite pour d'autres paramètres...
        };
